"""
A few additional notes on config:
    
1. All default config are stored in a dictionary in config.py which is imported and then 
...
config = {
            ...
            "SLEEP_TIME": 0.001,
            "LOCK_TIME": 0.01,
            "SHOW_WINDOW": True,        # False = hidden/headless terminal-only run
            "MODE": "shortcut",       # options: human, hamilton, astar, shortcut
            ...
            "SNAKE_LENGTH": 2,            # start length; use 2 for cleaner human/A*/Hamilton comparisons
            "FOOD_COLOR": (175, 0, 0),
            }